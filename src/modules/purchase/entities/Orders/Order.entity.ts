...
export class Order extends BaseEntity {
  ...
  @Column({ type: 'integer', name: 'document_type_purchase_id' })
  ...
  @ManyToOne(() => PurchaseDocumentType)
  @JoinColumn({ name: 'document_type_purchase_id' })
  documentTypePurchase: PurchaseDocumentType;
}
